...
#
# Script generated by Vivado on Mon Aug 21 14:22:24 CEST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : tcb_gpio_tb.sh
...
#
# Usage        : tcb_gpio_tb.sh
#                tcb_gpio_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tcb_gpio_tb.sh [-reset_run]
#                tcb_gpio_tb.sh [-reset_log]
#                tcb_gpio_tb.sh [-help]
#
...
#                script (type 'tcb_gpio_tb.sh -help' for more information).
#
...
# script info
echo -e "tcb_gpio_tb.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tcb_gpio_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/izi/VLSI/rp32/submodules/tcb/sim/questa/work"
  fi
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tcb_gpio_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tcb_gpio_tb.sh [-help]\n\
Usage: tcb_gpio_tb.sh [-step]\n\
Usage: tcb_gpio_tb.sh [-lib_map_path]\n\
Usage: tcb_gpio_tb.sh [-reset_run]\n\
Usage: tcb_gpio_tb.sh [-reset_log]\n\
Usage: tcb_gpio_tb.sh [-keep_index]\n\
Usage: tcb_gpio_tb.sh [-noclean_files]\n\n\
