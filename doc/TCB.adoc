...
| BUS     | https://en.wikipedia.org/wiki/Physical_layer#BUS[OSI model physical_layer]
...
In addition to the base protocol parameter `HSK_DLY` there are parameters for:
