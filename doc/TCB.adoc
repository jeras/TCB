...
| half |    aligned | `2'd0`     | `4'b1100`  | `{[0],[0],   ,   }`
| half | misaligned | `2'd1`     | `4'b0110`  | `{   ,[0],[0],   }`
| half |    aligned | `2'd2`     | `4'b0011`  | `{   ,   ,[0],[0]}`
| half | misaligned | `2'd3`     | `4'b1001`  | `{[0],   ,   ,[0]}`
| word |    aligned | `2'd0`     | `4'b1111`  | `{[0],[0],[1],[2]}`
| word | misaligned | `2'd1`     | `4'b1111`  | `{[2],[0],[0],[1]}`
| word | misaligned | `2'd2`     | `4'b1111`  | `{[1],[2],[0],[0]}`
| word | misaligned | `2'd3`     | `4'b1111`  | `{[0],[1],[2],[0]}`
|===
