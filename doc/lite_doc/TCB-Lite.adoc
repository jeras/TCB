...
| `1'b0`       | `siz==2'd2`         | `off[0]==1'b0`      | Instruction fetch for RISC-V with C extension.
| undefined    | `siz==CFG_BUS_OFF`  | `off=='d0`          | Full size, aligned.
| undefined    | `siz<=CFG_BUS_OFF`  | `off=='d0`          | Variable size, aligned to full size.
| unrestricted | `siz<=CFG_BUS_OFF`  | `off[siz-1:0]=='d0` | Variable size, aligned to transfer size.
