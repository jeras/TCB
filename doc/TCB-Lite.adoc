...
Logarithmic size, byte enable and endianness

Since bi-endianness support is an important part of the TCB-Lite protocol,
...
| `rsp.err` | `1`   | Error response (can be omitted if there are no error conditions).
|===
